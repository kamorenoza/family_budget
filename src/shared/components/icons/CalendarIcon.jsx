export default function CalendarIcon({ color = '#9e9e9e', className }) {
  return (
    <svg
    ...
    >
      ...
      />
      <path d="M7 4V2.5" stroke={color} strokeWidth="0.8399999999999999" strokeLinecap="round" />
      <path d="M17 4V2.5" stroke={color} strokeWidth="0.8399999999999999" strokeLinecap="round" />
      <path d="M2.5 9H21.5" stroke={color} strokeWidth="0.8399999999999999" strokeLinecap="round" />
