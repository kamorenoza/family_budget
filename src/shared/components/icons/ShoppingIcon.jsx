export default function ShoppingIcon({ color = '#9e9e9e', className }) {
  return (
    <svg
    ...
    >
      <path
        ...
        strokeWidth="0.72"
      />
      <path d="M15 11L16 17" stroke={color} strokeWidth="0.72" strokeLinecap="round" />
      <path d="M9 11L8 17" stroke={color} strokeWidth="0.72" strokeLinecap="round" />
      <path
