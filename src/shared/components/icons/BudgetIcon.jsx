export default function BudgetIcon({ color = '#ffffff', className }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M6 10H10" stroke={color} strokeWidth="0.9120000000000001" strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M17.9912 14H18.0002" stroke={color} strokeWidth="0.9120000000000001" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
